    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form id="request-form" class="forms-sample" action="{{route('policy.update.policy-update')}}"
                    method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="exampleTextarea1">Policy</label>
                        <textarea class="form-control" name="content" id="content" rows="10">{{$policy}}</textarea>
                    </div>
