...
<div class="row">
    <div class="col-xl-6 grid-margin stretch-card flex-column">
        <div class="d-flex align-items-baseline">
            <p class="mb-0"><a href="">Director Message</a></p>
            <i class="typcn typcn-chevron-right"></i>
            <p class="mb-0">Update Director Message</p>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Update Director Message</h4>
                <form id="request-form" class="forms-sample" action="{{route('directorMessage.update')}}"
                    method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="exampleTextarea1">Director Message</label>
