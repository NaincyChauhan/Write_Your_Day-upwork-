            ...
            <ul class="msg_box mb-3 mb-sm-5" id="post_container_{{$post->id}}">
                <li class="msg_extras_container d-flex align-items-center">
                    ...
                    <ul class="msg_extras_list d-flex flex-column hide">
                        <li class="msg_extra p-1 px-3 pt-2" onclick="HidePostRequest({{$post->id}},$(this))"><i class="fa fa-eye-slash side_icon"></i> Hide</li>
                        <li class="msg_extra p-1 px-3" onclick="ShowReportModal({{$post->id}});"><i class="fa fa-user-alt-slash side_icon"></i> Report</li>
                ...
                <li class="row align-items-center">
                            ...
                            <div class="radious_img">
                                ...
                                <div class="w-100 d-flex justify-content-center">
                                    <div class="post-user-image">
                                        <img class="w-100 h-auto" src="{{ isset($post->user->image) ? asset('storage/users/'.$post->user->image) : asset('assets/images/images.png') }}">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-9 ">
                        <div class="right_part">
                            ...
                            <h3><a href="{{route('detail-post-view',['type'=>$post->type,'slug'=>$post->slug_url])}}">{{$post->title}}">Loretm Ipsum is simply dummy text of the printing</a></h3>
                            <p>
                            ...
                            <ul class="like_comment d-flex justify-content-md-between align-items-center ">
                                <li class="d-flex justify-content-center align-items-center">
                                    ...
                                    <a class="heart like_post_">
                                     ...
                                     <!-- Post Comments -->
                                     <a class="d-flex custom-column-margin-1"><img src="{{ asset('assets/images/messsage.png') }}" /><span class="d-flex"><span class="d-block pr-4">{{$post->comments()->count()}}</span>
                                            Comments</span>
                                    </a>
                                    <form class="custom-column-margin-1" action="{{route('share-post')}}" method="POST"  id="share_post_form_{{$post->id}}">
                                        @csrf
                                        <input type="hidden" name="post_id" value="{{$post->id}}">
                                        <input type="hidden" name="post_type" value="{{$post->type}}">
