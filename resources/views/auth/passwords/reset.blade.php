                        ...
                        <fieldset class="password_field">
                            <legend>
                                ...
                                <div class="input-group d-flex align-items-center">
                                    ...
                                    <input type="password"  value="{{old('password')}}" name="password" max="32" class="password @error('password') is-invalid @enderror" id="user-password"
                                        placeholder="New Password">
                                    <i class="fa fa-eye-slash password-toogle"></i>
                                </div>
                                @if($errors->has('password'))
                                    <p id="password_error" class="error">{{ $errors->first('password') }}</p>
                                @endif
                            </legend>
                            <legend>
                                ...
                                @if($errors->has('password_confirmation'))
                                    <p id="confirm_password_error" class="error">{{ $errors->first('password_confirmation') }}</p>
                                @endif
                            </legend>
                            <legend
