                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <h4 style="color: gray;">We received a request to reset the password for your account.</h4>
                        <p>Your request submited successfully. Kindly use following otp to change your password.</p>
                        <p>
                            {{$mailData['otp']}} is the One Time Password (OTP) for your Password Reset, valid for 10 minutes. Do not share your OTP with anyone.
                        </p>
